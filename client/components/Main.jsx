        ...
        <form className="bg-gray-900 opacity-75 w-full mt-6 md:w-4/5 lg:w-3/5 shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4 self-center">
          <div className="mb-4">
            ...
            <div className="flex flex-wrap mb-8 mt-8">
              ...
              <input className="shadow appearance-none border rounded w-full md:w-4/5 p-3 text-gray-700 leading-tight focus:ring transform transition hover:scale-105 duration-300 ease-in-out" id="birthday" type="text" placeholder="17/07/2002" />
            </div>
          </div>
