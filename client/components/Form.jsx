...
export default function Form () {
  ...
  return (
    <>
      <div className="flex self-center justify-center items-center w-full md:my-8 pt-4 pb-12">
        <button className="w-2/3 md:w-1/3 py-5 text-xl self-center bg-gradient-to-r from-purple-800 to-green-500 opacity-50 hover:opacity-100 hover:from-pink-500 hover:to-green-500 text-white font-bold rounded-xl focus:ring transform transition hover:scale-105 duration-300 ease-in-out" type="button" onClick={handleFormClick}>Sign Up</button>
      </div>
      <div ref={formRef} className="pt-4 flex flex-col w-full justify-center lg:items-start overflow-auto">
        ...
        <form className="bg-gray-900 opacity-75 w-full mt-6 md:w-4/5 lg:w-3/5 shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4 self-center">
          <div className="mb-4">
            <div className="flex flex-wrap mb-8 mt-8">
              <label required className="block text-blue-300 py-2 font-bold mb-2 md:w-1/5 " htmlFor="firstName">First Name</label>
            ...
            <div required className="flex flex-wrap mb-8 mt-8">
