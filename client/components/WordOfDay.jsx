  ...
  return (
    <>
      <div className="container pt-24 md:pt-30 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        <div className="flex flex-col w-full p-8 md:p-12 mb-2 overflow-auto justify-center lg:items-start">
          ...
          <h1 className="my-4 text-3xl md:text-5xl text-white opacity-75 font-bold self-center text-center md:text-left">(tuh-ree)</h1>
          <h1 className="text-center my-4 text-3xl md:text-5xl font-bold self-center bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500">office, study, department</h1>
        </div>
      </div>
    </>
  )
